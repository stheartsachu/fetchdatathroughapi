			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('First Brewed')
							])),
						A2(
						$elm$html$Html$th,
						_List_Nil,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Contributed by')
							])),
						A2(
						$elm$html$Html$th,
						_List_Nil,
	...
	switch (model.$) {
		case 'Ready':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Click Here to fetch the Brewer Data')
					]));
		case 'Loading':
			return A2(
				$elm$html$Html$div,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Use the api and display the information')
					])),
				A2(
